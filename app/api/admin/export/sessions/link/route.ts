/**
 * POST: Generate a signed CSV download link for interview sessions (deeppivot-312).
 * Admin-only. Body: { from?, to?, includeDeleted? }
 */
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        console.error("Failed to generate sessions export link:", error);
