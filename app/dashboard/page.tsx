...
export default async function DashboardPage() {
  try {
    ...
    // Re-throw redirects — Next.js uses thrown errors for redirect()
    if (isRedirectError(err)) throw err;
    // Log for Vercel function logs
    console.error("[DashboardPage] Unhandled render error:", err);
    // Fallback: render a minimal page instead of crashing
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center">
        <h1 className="text-2xl font-bold">Welcome to your Dashboard</h1>
        <p className="mt-2 text-muted-foreground">
          Some widgets failed to load. Please try refreshing.
        </p>
